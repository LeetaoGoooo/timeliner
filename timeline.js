...
;(function ($, window, document, undefined) {
    ...
    Timeliner.prototype = {
        ...
        renderHtml: function () {
            ...
            this.$ele.html(style+'<div class="container">' + html.join("") + '</div>');
        }
    };
