...
;(function ($, window, document, undefined) {
    ...
    Timeliner.prototype = {
        ...
        renderHtml: function () {
            ...
            for (var i = 0; i < len; i++) {
                html.push('<div class="timeline-item"><div class="timeline-icon"><img src="' + content[i].img + '"></div><div class="timeline-content"><h2>' + content[i].date + '</h2><p>' + content[i].content + '</p></div></div>');
            }
